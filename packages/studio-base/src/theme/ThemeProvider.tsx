...
const icons: {
  ...
  CaretDown: <Icons.CaretSolidDownIcon />,
  CaretLeft: <Icons.CaretSolidLeftIcon />,
  CaretRight: <Icons.CaretSolidRightIcon />,
  CaretUp: <Icons.CaretSolidUpIcon />,
