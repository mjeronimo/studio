...
import SystemView from "@foxglove/studio-base/panels/SystemView";
...
export const TopicToRender = (): JSX.Element => {
  ...
  return (
    ...
    >
      <SystemView overrideConfig={{ searchTerms: [], minLogLevel: 1, topicToRender: "/foo/rosout" }} />
    </PanelSetup>
  );
};
